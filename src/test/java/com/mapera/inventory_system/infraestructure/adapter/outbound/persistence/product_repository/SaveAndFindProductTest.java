...
import com.mapera.inventory_system.infrastructure.adapter.outbound.persistence.repository.CategoryRepository;
import com.mapera.inventory_system.infrastructure.adapter.outbound.persistence.repository.ProductRepository;
import com.mapera.inventory_system.infrastructure.adapter.outbound.persistence.repository.SubcategoryRepository;
...
public class SaveAndFindProductTest {
    ...
    public void test() {
        ...
        Mono<ProductEntity> foundProductMono = savedProductMono
                .flatMap(savedProduct -> productRepository.findProductById(savedProduct.getId()));
